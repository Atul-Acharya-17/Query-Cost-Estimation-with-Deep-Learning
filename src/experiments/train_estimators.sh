...
python3 -m code.train.train_tree_gbm --dataset=imdb --size=100000 --name=tree_lgbm --num-models=5 --method=lgbm --depth=8 --learning-rate=0.1 --n_estimators=100

python3 -m code.train.train_tree_gbm --dataset=imdb --size=100000 --name=tree_lgbm --num-models=5 --method=lgbm --depth=8 --learning-rate=0.1 --n_estimators=100 --fast-inference

python3 -m code.train.train_tree_gbm --dataset=imdb --size=100000 --name=tree_xgb --num-models=5 --method=xgb --depth=16 --learning-rate=0.1 --n_estimators=100
